...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `contact` (`contact_name`, `contact_studid`, `contact_phone`, `contact_email`, `contact_desc`) VALUES (?, ?, ?, ?, ?)";
