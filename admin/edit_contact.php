...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `contact` SET `contact_name`=?, `contact_studid`=?, `contact_phone`=?, `contact_email`=?, `contact_desc`=? WHERE `contact_id`=?";
  
  $stmt = mysqli_prepare($conn, $sql);
  mysqli_stmt_bind_param($stmt, 'sssssi', $contact_name, $contact_studid, $contact_phone, $contact_email, $contact_desc, $contact_id);
