...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `members`(`id`, `first_name`, `last_name`, `email`, `gender`, `username`, `password`) VALUES (NULL, ?, ?, ?, ?, ?, ?)";
    ...
    // Bind parameters
    mysqli_stmt_bind_param($stmt, "ssssss", $first_name, $last_name, $email, $gender, $username, $hashed_password);
    ...
    if ($result) {
        ...
        echo "Failed to insert record: " . mysqli_stmt_error($stmt);
    }
